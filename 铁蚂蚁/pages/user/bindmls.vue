    ...
    <div class="bg_f8f8f8">
		...
		<div class="main">
			<div class="dd_msgBox bind__msgBox" style="padding:.1rem .12rem;">
				...
				<p class="color_e40000">1、请输入美丽说用户名</p>
						...
						<div class="weui-cells">
							<div class="weui-cell">
								<div class="weui-cell__bd">
									<input type="text" class="weui-input"  id="mlsName" @input="jdName" placeholder="请输入美丽说账号" />
								</div>
							</div>
							<div class="weui-cell">
								<div class="weui-cell__bd">
							...
							<div class="weui-cell">
								<div class="weui-cell__bd">
									<input type="text" class="weui-input" @input="xiangxidizhi" id="xiangxidizhi" placeholder="请输入详细地址" />
								</div>
							</div>
						</div>
					</form>
			...
			<a href="javascript:;" class="weui-btn weui-btn-active btn-submit" @click="submit" style="margin:.15rem .12rem .2rem;">提交审核</a>
		</div>
	</div>
</template>
